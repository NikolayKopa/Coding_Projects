...
#Since there are multiple shapes, a piece class to store information is very useful.
class Piece(object):  # *
...
def draw_text_middle(surface, text, size, color):
    ...
    surface.blit(label, (top_left_x + grid_width /2 - (label.get_width()/2), top_left_y + grid_height/2 - label.get_height()/2))
...
def max_score():
    ...
    return score
#This function displays a timer for the game and player.
def draw_timer():
    pass
...
def main(win):  # *
    ...
    while run:
        ...
        screen.blit(timerText, (top_left_x - 200, top_left_y - 40))
        screen.blit(counting_text, (top_left_x - 200, top_left_y - 20))
        pygame.display.update()
        clock.tick(25)
